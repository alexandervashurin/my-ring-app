...
Приложение создает следующие файлы логов:
...
2026-02-05 15:33:45.678 [qtp534199755-24] ERROR my-ring-app.logger - ERROR: SQL error | MESSAGE: Ошибка при создании записи | CONTEXT: {:table "Работник", :data {...}}

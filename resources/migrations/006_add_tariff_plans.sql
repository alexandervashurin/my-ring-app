...
INSERT OR IGNORE INTO Тарифный_план (id, code, name, max_workers, max_orgs, features, price_monthly, price_yearly, is_active, sort_order) VALUES
    (1, 'free', 'Бесплатный', 10, 1, '{"export":false,"reports":false,"api":false,"audit":false,"1c":false,"email":false,"analytics":false,"support":"community"}', 0, 0, 1, 0),
    (2, 'pro', 'Pro', 50, 3, '{"export":true,"reports":true,"api":false,"audit":true,"1c":false,"email":true,"analytics":true,"support":"email"}', 2990, 29900, 1, 1),
    (3, 'enterprise', 'Enterprise', 999999, 999999, '{"export":true,"reports":true,"api":true,"audit":true,"1c":true,"email":true,"analytics":true,"support":"dedicated"}', 9990, 99900, 1, 2);

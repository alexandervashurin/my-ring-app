...
- `year` — год расчёта (по умолчанию — текущий)
- `month` — месяц расчёта 1–12 (по умолчанию — текущий)

**Данные:**
- Информация о работнике
- Селектор периода (год/месяц)
- Детальный расчёт зарплаты за выбранный период
- История начислений

...
INSERT OR IGNORE INTO "Организация" (id, name, inn, phone, email, address, is_active) VALUES
    (2, 'ООО "ТехноПром"', '7701234567', '+7 (495) 123-45-67', 'info@technoprom.ru', 'г. Москва, ул. Промышленная, д. 10', TRUE),
    (3, 'АО "Металлург"', '7802345678', '+7 (812) 234-56-78', 'office@metallurg.spb.ru', 'г. Санкт-Петербург, пр. Металлистов, д. 25', TRUE),
    (4, 'ПАО "АвтоВАЗ"', '1650034567', '+7 (8352) 034-56-7', 'hr@avtovaz.com', 'г. Тольятти, ул. Автозаводская, д. 1', TRUE),
    (5, 'ЗАО "СтройМаш"', '5260045678', '+7 (831) 045-67-89', 'kontakt@stroymash.nnov.ru', 'г. Нижний Новгород, ул. Индустриальная, д. 15', TRUE),
    (6, 'ООО "ЭнергоСеть" (деактивирована)', '6670056789', '+7 (343) 056-78-90', 'info@energoset.ru', 'г. Екатеринбург, ул. Энергетиков, д. 8', FALSE);
